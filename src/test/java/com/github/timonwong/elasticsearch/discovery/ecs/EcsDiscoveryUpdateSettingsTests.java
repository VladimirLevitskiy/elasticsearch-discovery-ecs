...
// * starting.
// * This test requires ECS to run.
// */
//@ESIntegTestCase.ClusterScope(scope = Scope.TEST, numDataNodes = 0, numClientNodes = 0, transportClientRatio = 0.0)
//public class EcsDiscoveryUpdateSettingsTests extends AbstractTestCase {
//    public void testMinimumMasterNodesStart() {
//        Settings nodeSettings = Settings.builder()
//            .put(DiscoveryModule.DISCOVERY_SEED_PROVIDERS_SETTING.getKey(), "ecs")
//            .build();
